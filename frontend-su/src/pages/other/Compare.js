...
const Compare = () => {
  ...
  const {
    ...
    currency,
    addToCartHandler,
    deleteFromCompareHandler,
    deleteAllFromCompareHandler,
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            {compareItems.map((compareItem, key) => {
                              const cartItem = cartItems.find((item) => item.id === compareItem.id);
                              ...
                              return (
                                <td className="product-image-title" key={key}>
                                  <div className="compare-remove">
                                    <button
                                      onClick={() => {
                                        deleteFromCompareHandler(compareItem);
                                        cogoToast.success('Removed from compare', {
                    ...
                    <div className="cart-shiping-update-wrapper">
                      <div className="cart-clear">
                        <button
                          onClick={() => {
                            deleteAllFromCompareHandler();
                            cogoToast.success('Compare cleared', {
                              position: 'bottom-left',
                            });
                          }}
                        >
